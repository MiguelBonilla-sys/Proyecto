...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div>
                ...
                <a class="btn btn-primary" href="registro.jsp"><i class="bi bi-person-plus"></i> Registrarse</a>
            </div>
        </div>
    </nav>
    ...
    <div class="hero bg-light text-center py-5" style="margin-top: 80px;">
        ...
        <a href="registro.jsp" class="btn btn-primary me-2"><i class="bi bi-person-plus"></i> Comenzar Ahora</a>
